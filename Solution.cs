...
{
    private static readonly int NOT_A_CONFUSING_NUMBER = -1;
    private static readonly int[] MAP_ROTATED_CONFUSING_NUMBERS
    ...
    public bool ConfusingNumber(int inputValue)
    {
